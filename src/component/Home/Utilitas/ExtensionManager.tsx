...
const INITIAL_SOURCES: SourceConfig[] = [
  ...
  },
  {
    ...
    type: 'Comics',
    language: 'ID',
    description: 'Sumber baca komik dari Shinigami.',
    isDefault: false,
    isActive: false,
  },
  {
    ...
    type: 'Comics',
    language: 'ID',
    description: 'Sumber komik dengan koleksi Manga, Manhwa, dan Manhua terlengkap.',
    isDefault: false,
    isActive: false,
  },
  {
  ...
  },
  {
    ...
    type: 'Anime',
    language: 'ID',
    description: 'Sumber anime dari Animelovers.',
    isDefault: false,
    isActive: false,
  },
];
